<script>
    ...
    const principles = [
        { title: 'Zooble', description: "/images/Zooble Drawing.jpg" },
...
<section class="intro section-hero">
    ...
    <p>
       Hello!
       My name is Mikey Perrozzi. I'm a 20 year old college student
       currently studying Digital Art and Design in SETU. I have a passion for art, acting, music and more!
       Here on my portfolio site, you can see some of my art pieces. Hope you enjoy 
    </p>
</section>
